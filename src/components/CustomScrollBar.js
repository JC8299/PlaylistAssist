...
function CustomScrollBar({
    ...
    const handleThumbPosition = useCallback(() => {
        ...
        // console.log(`clientHeight: ${clientHeight}, scrollHeight: ${scrollHeight}, trackHeight: ${trackHeight}, thumbHeight: ${thumbHeight}, maff: ${(clientHeight/scrollHeight)*trackHeight}`);
